...
class SafeSQL
{
    ...
    public $_drop_values = array('');

    /*======================================================================*\
        Function: SafeSQL
        Purpose:  constructor
    \*======================================================================*/
    public function SafeSQL()
    {
    }
    ...
    \*======================================================================*/
    public function query($query_string, $query_vars)
    {
            ...
            for ($_x = $_var_count - 1; $_x >= 0; $_x--) {
                ...
                if (in_array($_match[0][$_x], array('%S','%I','%F','%C','%L','%Q','%N'))) {
                    ...
                    if (in_array($query_vars[$_x], $this->_drop_values, true)) {
                        ...
                        $_last_var_pos = null;
                    } elseif ($_x > 0 && $_var_pos[$_x - 1] > $_left_pos) {
    ...
    \*======================================================================*/
    public function _convert_var($var, $type)
    {
        switch ($type) {
            case '%i':
            case '%I':
    ...
    /*======================================================================*\
        ...
        Purpose:
    \*======================================================================*/
    public function set_drop_values($drop_values)
    {
    ...
    /*======================================================================*\
        ...
        Purpose:
    \*======================================================================*/
    public function get_drop_values()
    {
...
class SafeSQL_MySQL extends SafeSQL
{
    ...
    /*======================================================================*\
        ...
        Purpose:  constructor
    \*======================================================================*/
    public function SafeSQL_MySQL($link_id = null)
    {
    ...
    \*======================================================================*/
    public function _sql_escape($var)
    {
        if (is_array($var)) {
