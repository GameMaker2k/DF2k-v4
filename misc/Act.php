...
$TB2k = "Tag Boards 2k";
$DF2kURL1 = "<a href=\"http://df2k.berlios.de/DF2k/index.php?act=View\">";
$DF2kURL2 = $DF2kURL1.$DF2k."</a>";
$TB2kURL1 = "<a href=\"http://df2k.berlios.de/DF2k/TagBoard.php?act=View\">";
$TB2kURL2 = $TB2kURL1.$TB2k."</a>";
$PHPQA = "PHP-Quick-Arcade";
$VER1 = "4.0.0";
$VER2 = "Pre-Alpha 5";
$VER3 = "PA 5";
$DF2kV1 = $DF2kURL2." v. ".$VER1;
$DF2kV2 = $DF2kURL2." v. ".$VER1." ".$VER2;
$DF2kV3 = $DF2kURL2." v. ".$VER1." ".$VER3;
$TB2kV1 = $TB2kURL2." v. ".$VER1;
$TB2kV2 = $TB2kURL2." v. ".$VER1." ".$VER2;
